                        ...
                        <div class="col-span-2 ">
                            ...
                            <select id="province" name="province_code" required
                                ...
                                @foreach ($provinces as $province)
                                    <option value="{{ $province->province_code }}">{{ $province->province_name }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#province').change(function() {
                ...
                $('#district').html(
                    '<option selected disabled>Select District</option>'); // Reset district dropdown
                $('#subdistrict').html(
                    '<option selected disabled>Select Subdistrict</option>'); // Reset subdistrict dropdown
                        ...
                        success: function(data) {
                            $.each(data, function(key, district) {
                                $('#district').append('<option value="' + district
                                    .district_code + '">' + district.district_name +
                                    '</option>');
                            });
                        }
                    });
