...
<div class="container">
    ...
    <form action="{{ route('companies.update', $company->id) }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="segment" name="segment" value="{{ $company->segment }}" required>
        </div>
        <div class="form-group">
            <label for="sub_segment">Sub Segment</label>
            <input type="text" class="form-control" id="sub_segment" name="sub_segment" value="{{ $company->sub_segment }}">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="social_media" name="social_media" value="{{ $company->social_media }}">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="post_code" name="post_code" value="{{ $company->post_code }}">
        </div>
