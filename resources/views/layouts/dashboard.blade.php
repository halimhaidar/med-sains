                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center justify-start rtl:justify-end">
                        ...
                        <a href="{{ route('home') }}" class="flex ms-2 md:me-24">
                            ...
                            <span
                                class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">MEDISAINS</span>
                        </a>
                ...
                <ul class="space-y-2 font-medium">
                    ...
                    <li>
                        <a href="{{ route('contacts.index') }}"
                            class="flex items-center p-2 {{ Request::is('contacts*') ? 'text-blue-500' : 'text-gray-900' }} rounded-lg dark:{{ Request::is('contacts*') ? 'text-blue-500' : 'text-white' }} hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                viewBox="0 0 20 18">
                                <path
                    ...
                    <li>
                        <a href="{{ route('category.index') }}"
                            class="flex items-center p-2 {{ Request::is('category*') ? 'text-blue-500' : 'text-gray-900' }} rounded-lg dark:{{ Request::is('category*') ? 'text-blue-500' : 'text-white' }} hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                viewBox="0 0 24 24">
                                <path
                    ...
                    <li>
                        <a href="{{ route('brands.index') }}"
                            class="flex items-center p-2 {{ Request::is('brands*') ? 'text-blue-500' : 'text-gray-900' }} rounded-lg dark:{{ Request::is('brands*') ? 'text-blue-500' : 'text-white' }} hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <li>
                        <a href="{{ route('products.index') }}"
                            class="flex items-center p-2 {{ Request::is('products*') ? 'text-blue-500' : 'text-gray-900' }} rounded-lg dark:{{ Request::is('products*') ? 'text-blue-500' : 'text-white' }} hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                viewBox="0 0 18 20">
                                <path
                    ...
                    <li>
                        <a href="{{ route('leads.index') }}"
                            class="flex items-center p-2 {{ Request::is('leads*') ? 'text-blue-500' : 'text-gray-900' }} rounded-lg dark:{{ Request::is('leads*') ? 'text-blue-500' : 'text-white' }} hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                viewBox="0 0 18 20">
                                <path
                    ...
                    <li>
                        <a href="{{ route('quotations.index') }}"
                            class="flex items-center p-2 {{ Request::is('quotations*') ? 'text-blue-500' : 'text-gray-900' }} rounded-lg dark:{{ Request::is('quotations*') ? 'text-blue-500' : 'text-white' }} hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                viewBox="0 0 18 20">
                                <path
