...
@section('content')
@if (session('success'))
<div id="successMessage" class="bg-green-400 border border-green-400 text-black dark:text-white px-4 py-3 rounded-lg mb-5" role="alert">
...
<div class="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-md w-full mx-auto">
    ...
    <div class="flex items-start justify-between">
        <div class="flex">
            <!-- Adjust this section -->
            <div class="bg-pink-200 text-pink-600 font-semibold text-lg px-4 py-2 rounded-md flex items-center justify-center">
                {{ $data->id }}
            </div>
            <div class="ml-4">
...
<div class="mb-4 border-b border-gray-200 dark:border-gray-700">
    <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="default-tab" data-tabs-toggle="#default-tab-content" role="tablist">
        ...
        <li class="me-2" role="presentation">
            <button class="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" id="edit-tab" data-tabs-target="#edit" type="button" role="tab" aria-controls="edit" aria-selected="false">Edit</button>
        </li>
        <li class="me-2" role="presentation">
...
<div id="default-tab-content">
    <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="overview" role="tabpanel" aria-labelledby="overview-tab">
        <div id="pdf-content" style="margin: 40px; padding: 20px; border: 2px solid black;">
            <h1 style="margin-bottom: 20px; color: red;">PDF with CSS Margins</h1>
            <p style="margin-bottom: 15px;">This paragraph has custom margins using CSS.</p>
            <p style="margin: 10px 0;">You can control margins inside the HTML like this.</p>
        </div>

        <button id="generate-pdf" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 disabled:bg-gray-400 disabled:cursor-not-allowed dark:disabled:bg-gray-700 dark:disabled:text-gray-500">Generate PDF</button>
    </div>
    <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="edit" role="tabpanel" aria-labelledby="edit-tab">
        ...
        <div class="mb-4 border-b border-gray-200 dark:border-gray-700">
            <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="default-styled-tab" data-tabs-toggle="#default-styled-tab-content" data-tabs-active-classes="text-purple-600 hover:text-purple-600 dark:text-purple-500 dark:hover:text-purple-500 border-purple-600 dark:border-purple-500" data-tabs-inactive-classes="dark:border-transparent text-gray-500 hover:text-gray-600 dark:text-gray-400 border-gray-100 hover:border-gray-300 dark:border-gray-700 dark:hover:text-gray-300" role="tablist">
                <li class="me-2" role="presentation">
                    <button class="inline-block p-4 border-b-2 rounded-t-lg" id="general-styled-tab" data-tabs-target="#styled-general" type="button" role="tab" aria-controls="general" aria-selected="false">General</button>
                </li>
                <li class="me-2" role="presentation">
                    <button class="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" id="offerconditions-styled-tab" data-tabs-target="#styled-offerconditions" type="button" role="tab" aria-controls="offerconditions" aria-selected="false">Offer
                        Conditions</button>
                </li>
                <li class="me-2" role="presentation">
                    <button class="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" id="address-styled-tab" data-tabs-target="#styled-address" type="button" role="tab" aria-controls="address" aria-selected="false">Address</button>
                </li>
                <li class="me-2" role="presentation">
                    <button class="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" id="pdfsetting-styled-tab" data-tabs-target="#styled-pdfsetting" type="button" role="tab" aria-controls="pdfsetting" aria-selected="false">PDF Setting</button>
                </li>
                <li class="me-2" role="presentation">
        ...
        <div id="default-styled-tab-content">
            <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="styled-general" role="tabpanel" aria-labelledby="general-tab">
                    ...
                    <form class="p-10" action="{{ route('quotations.nextStepDetail', $data->id) }}" method="POST">
                        ...
                        <div class="grid gap-4 mb-4 sm:grid-cols-4">
                            <div class="col-span-2">
                                <label for="quotation_ids" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Quotation ID
                                </label>
                                <input type="text" name="id" id="quotation_ids" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" value="{{ isset($quotation) ? $quotation->id : '' }}" readonly />
                            </div>
                            <div class="col-span-2">
                                <label for="category_quotation" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Category
                                </label>
                                <select id="category_quotation" name="category" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                            ...
                            <div class="col-span-2">
                                ...
                                <select id="source" name="source" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                    <option value="" disabled selected>Choose</option>
                            ...
                            <div class="">
                                <label for="closing_date_target" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Closing Date
                                    Target
                                </label>
                                <input type="date" name="closing_date_target" id="closing_date_target" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" value="{{ isset($quotation) ? $quotation->closing_date_target : '' }}" />
                            </div>
                            <div class="col-span-2">
                        ...
                        <div class="flex w-full justify-end">
                            <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 disabled:bg-gray-400 disabled:cursor-not-allowed dark:disabled:bg-gray-700 dark:disabled:text-gray-500">
                                Edit General Data
                            </button>
                        </div>
                    </form>
            ...
            <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="styled-offerconditions" role="tabpanel" aria-labelledby="offerconditions-tab">
                <form class="p-10" action="{{ route('quotations.nextStepDetail', $data->id) }}" method="POST">
                    @csrf
                    <input type="text" name="type" value="offer_condition" style="display: none;" />
                    <div class="grid gap-4 mb-4 sm:grid-cols-4">
                        <div class="col-span-2">
                            <label for="quotation_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Quotation ID
                            </label>
                            <input type="text" name="id" id="quotation_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" value="{{ isset($quotation) ? $quotation->id : '' }}" readonly>
                        </div>
                        <div class="col-span-2">
                            <label for="franco" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Franco
                            </label>
                            <input type="text" name="franco" id="franco" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" value="{{ isset($quotation) ? $quotation->franco : '' }}">
                        </div>
                        <div class="col-span-2">
                            <label for="validity" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Validity
                            </label>
                            <input type="date" name="validity" id="validity" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" value="{{ isset($quotation) ? $quotation->validity : '' }}">
                        </div>
                        <div class="col-span-2">
                            <label for="delivery_estimation" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Delivery
                                Estimation
                            </label>
                            <input type="date" name="delivery_estimation" id="delivery_estimation" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" value="{{ isset($quotation) ? $quotation->delivery_estimation : '' }}">
                        </div>
                        <div class="col-span-2">
                            <label for="delivery_condition" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Delivery Condition
                            </label>
                            <select id="delivery_condition" name="delivery_condition" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                <option value="" disabled selected>Choose</option>
                        ...
                        <div class="col-span-2">
                            ...
                            <select id="term_of_payment" name="term_of_payment" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                <option value="" disabled selected>Choose</option>
                                @foreach ($top as $item)
            ...
            <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="styled-address" role="tabpanel" aria-labelledby="address-tab">
                <div class="flex justify-end">
                    <button data-modal-target="crud-modal" data-modal-toggle="crud-modal" class="me-10 block max-h-fit text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800" type="button">
                        Add New Address
                    </button>
                </div>
                <div id="crud-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 bottom-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                ...
                <form class="p-10" action="{{ route('quotations.nextStepDetail') }}" method="POST">
                    ...
                    <input type="text" name="id" value="{{ isset($quotation) ? $quotation->id : '' }}" style="display: none;" />
                    <input type="text" name="contact_id" value="{{ isset($data) ? $data->contact_id:''}}" style="display: none;" />
                    <input type="text" name="lead_id" class="form-control" value="{{ isset($data)?$data->lead_id:''}}" style="display: none;">
                    <div class="grid gap-4 mb-4 sm:grid-cols-4">
                        <div class="col-span-2">
                            <label for="contact_address_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Contact
                                Address
                            </label>
                            <select id="contact_address_id" name="contact_address_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                <option value="" disabled selected>Choose</option>
                        ...
                        <div class="col-span-2">
                            <label for="contact_province" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Province
                            </label>
                            <input type="text" name="contact_province" id="contact_province" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" value="{{ isset($data) ? $data->contact_province : '' }}" readonly />
                        </div>
                        <div class="col-span-2">
                            <label for="contact_city" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">City

                            </label>
                            <input type="text" name="contact_city" id="contact_city" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" value="{{ isset($data) ? $data->contact_city : '' }}" readonly />
                        </div>
                        <div class="col-span-2">
                            <label for="contact_post_code" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Post Code
                            </label>
                            <input type="text" name="contact_post_code" id="contact_post_code" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" value="{{ isset($data) ? $data->contact_post_code : '' }}" readonly />
                        </div>
                    </div>
                    <div class="flex w-full justify-end">
                        <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 disabled:bg-gray-400 disabled:cursor-not-allowed dark:disabled:bg-gray-700 dark:disabled:text-gray-500">
            ...
            <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="styled-pdfsetting" role="tabpanel" aria-labelledby="pdfsetting-tab">
                <form action="{{ route('quotations.nextStepDetail') }}" method="POST">
                    ...
                    <div class="grid gap-4 mb-4 sm:grid-cols-4">
                        <input type="text" name="id" id="contact_post_code" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" value="{{ isset($quotation)?$quotation->id:''}}" readonly style="display: none;" />

                        <div class="col-span-2">
                            <label for="pdf_show" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Show Total
                            </label>
                            <input type="text" name="pdf_show" id="pdf_show" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" value="{{ isset($quotation)?$quotation->pdf_show:''}}" />
                        </div>
                        <div class="col-span-2">
                            <label for="pdf_show_decimal" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Show Decimal
                            </label>
                            <input type="text" name="pdf_show_decimal" id="pdf_show_decimal" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" value="{{ isset($quotation)?$quotation->pdf_show_decimal:''}}" />
                        </div>
                        <div class="col-span-2">
                            <label for="margin_1" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Margin 1
                            </label>
                            <input type="text" name="margin_1" id="margin_1" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" value="{{ isset($quotation)?$quotation->margin_1:''}}" />
                        </div>
                        <div class="col-span-2">
                            <label for="margin_2" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Margin 2
                            </label>
                            <input type="text" name="margin_2" id="margin_2" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" value="{{ isset($quotation)?$quotation->margin_2:''}}" />
                        </div>
                    </div>
                    <div class="flex w-full justify-end">
                        <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 disabled:bg-gray-400 disabled:cursor-not-allowed dark:disabled:bg-gray-700 dark:disabled:text-gray-500">
                ...
                <form class="p-10" action="{{ route('quotations.nextStep') }}" method="POST">
                    ...
                    <div class="flex justify-between">
                        ...
                        <div>
                            ...
                            <select id="product_id" name="product_id" onchange="onChangeProduct()" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                <option value="" disabled selected>Choose</option>
    ...
    <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="settings" role="tabpanel" aria-labelledby="settings-tab">
        <p class="text-sm text-gray-500 dark:text-gray-400">This is some placeholder content the <strong class="font-medium text-gray-800 dark:text-white">Settings tab's associated content</strong>. Clicking
    ...
    <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="contacts" role="tabpanel" aria-labelledby="contacts-tab">
        <p class="text-sm text-gray-500 dark:text-gray-400">This is some placeholder content the <strong class="font-medium text-gray-800 dark:text-white">Contacts tab's associated content</strong>. Clicking
            another tab will toggle the visibility of this one for the next. The tab JavaScript swaps classes to control
            the content visibility and styling.</p>
    </div>
</div>
